...
<body class="fixed-header sidebar-right-close sidebar-left-close">
    ...
    <div class="loader justify-content-center pink-gradient">
        <div class="align-self-center text-center">
            ...
            <h2 class="mt-3 font-weight-light">PPDB SMKN2</h2>
                ...
                <div class="col-12 col-md-6 h-md-100 order-2 order-md-1">
                    <div class="row align-items-center h-100">
                        <div class="col-12 col-md-10 col-lg-8 col-xl-6 mx-auto mt-2">
                            ...
                            <h4 class="font-weight-light mb-5 content-color-secondary text-left">Silahkan masuk ke akunmu<br> yang telah di daftarkan.</h4>
                            <?= $this->session->flashdata('success'); ?>
                            <?= $this->session->flashdata('error'); ?>
                            <form action="<?= site_url('login/masuk'); ?>" method="post">
                                <div class="card mb-2">
                                    <div class="card-body p-0">
                                        <label for="nisn" name="nisn" class="sr-only">NISN</label>
                                        <input type="text" id="nisn" name="nisn" class="form-control form-control-lg border-0" placeholder="Nisn" required="" autocomplete="off">
                                        <hr class="my-0">
                                ...
                                <button type="submit" href="javascript:void(0)" class="float-left mb-4 btn btn-primary pink-gradient  dark-maroon text-white">Login</button>
                                </div>
                            </form>
                        </div>
                    </div>
